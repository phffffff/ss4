...
import { getDataApi, postDataApi, checkDataApi, rejectDataApi, delDataApi } from '../../../redux/actions/todoAcitonReduxThunk'
...
function TodoList() {
    ...
    const handlePostData = (stateTodo) => {
        dispatch(postDataApi(stateTodo))
    }
    ...
    const handleCheckTask = (task) => {
        dispatch(checkDataApi(task))
    }

    const handleRejectTast = (task) => {
        dispatch(rejectDataApi(task))
    }

    const handleDelTast = (task) => {
        dispatch(delDataApi(task))
    }
                ...
                <div className="card__content">
                    ...
                    <div className="card__add">
                        ...
                        <button type='button' id="addItem"
                            onClick={() => { handlePostData(stateTodo) }}
                        >
